...
//		System.out.println("Righe:"+ m.getRows() + " Colonne:" + m.getCols());
//		System.out.println(m.toString());
		Matrix m1 = new Matrix(new double[][] { { 2, 1, 1 }, { 1, 1, 0 },
				{ 0, 0, 1 } });
//		System.out.println("Righe:"+ m1.getRows() + " Colonne:" + m1.getCols());
...
//		
		...
		m1 = new Matrix(new double[][] { { 2, 1, 1, 1 }, { 1, 1, 0, 1 },
				{ 0, 0, 1, 1 } });
		Matrix sum_m_m2 = m.sum(m1);
		assert(sum_m_m2 == null);
...
//		assert(1.0 == minor.getValue(1, 1));
		...
		m1 = new Matrix(new double[][] { { 2, 3 , 5}, { 2, 2, 1 }, {5, 2, 1} });
		double det = m1.det();
