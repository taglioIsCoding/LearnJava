...
public void setUp() {
    ...
    zt = new Tassametro(tds.toArray(new ITariffaTaxi[0]), getFasceOrarie());
	...
	public void testTassametro_SoloDistanza_T1_T2_failed() {
		CorsaTaxi ct = new CorsaTaxi("C1", LocalTime.of(10, 10), 60, 600);  // velocit� multipla di 85m sarebbe 60.72
			System.out.println("numero rilevazioni: " + ct.getRilevazioniDistanze().length);
